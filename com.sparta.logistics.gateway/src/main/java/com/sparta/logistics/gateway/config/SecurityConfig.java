...
import com.sparta.logistics.gateway.dto.UserDto;
...
public class SecurityConfig {
    ...
    public WebFilter jwtAuthenticationFilter(RedisService redisService) {
        ...
        return (exchange, chain) -> {
            ...
            if (exchange.getRequest().getURI().getPath().equals("/user/auth/signIn") || exchange.getRequest().getURI().getPath().equals("/user/auth/signUp")) {
                log.info("필터 로그");
            ...
            if (authHeader != null && authHeader.startsWith("Bearer ")) {
                ...
                try {
                    ...
                    ServerHttpRequest modifiedRequest = exchange.getRequest().mutate()
                        ...
                        .header("X-User-Roles", userDto.getRole())    // 권한 정보 헤더 추가
                        .build();
